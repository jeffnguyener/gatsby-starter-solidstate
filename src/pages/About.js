    ...
    <section id="wrapper">
      ...
      <div className="wrapper">
        <div className="inner">
          ...
          <p>
          On my off time, I enjoy traveling and hiking through national parks around the U.S. with my wife. I also love photography and spending time with my family & my closest friends. 
          </p>
